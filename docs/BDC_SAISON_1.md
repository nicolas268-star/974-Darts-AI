...
`bdc-round-one-details.json` contient la vue normalisée de la manche : 28 matchs de poule, 4 matchs de phase finale, classement de poule et statistiques individuelles disponibles. L’ordre officiel des joueurs correspond à l’ordre des noms dans chaque duo et a été confirmé par l’organisateur. Seules 16 feuilles sur 32 conservent néanmoins des séquences individuelles assez complètes pour répartir toutes les volées. Un contrôle global des 16 feuilles partielles a permis d’attribuer 36 finishes enregistrés sur 15 feuilles grâce à cet ordre fixe. La seizième feuille ne contient plus aucune séquence. Les legs ajoutés manuellement après l’incident restent indisponibles et ne sont jamais reconstitués.
